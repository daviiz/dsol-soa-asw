...
public class Submarine extends EventProducer implements EventListenerInterface,Locatable{
	...
	public Submarine(ModelData data,final DEVSSimulatorInterface.TimeDouble simulator) throws RemoteException, SimRuntimeException
    {
		this._vdata = data;
        ...
        //_t1 = new Torpedo(this._vdata.name +"_torpedo1",this._vdata.origin.x,this._vdata.origin.y,simulator);
        //_t2 = new Torpedo(this._vdata.name +"_torpedo2",this._vdata.origin.x,this._vdata.origin.y,simulator);
        weaponCounts = 2;
