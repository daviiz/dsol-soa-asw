...
public class ASWModel extends AbstractDSOLModel.TimeDouble<DEVSSimulatorInterface.TimeDouble>
{
    ...
    public void constructModel() throws SimRuntimeException
    {
        try
        {
            ...
            //视图组件注册：
        	try {
        		Visual2dService.getInstance().addVisualComponent("Fleet_1",new Visual2dRender(f1, simulator, new ModelData("Fleet_1")));
        		Visual2dService.getInstance().addVisualComponent("Fleet_2",new Visual2dRender(f2, simulator, new ModelData("Fleet_2")));
