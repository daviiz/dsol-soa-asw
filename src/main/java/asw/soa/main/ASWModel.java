...
/**
 * <p>
 * Copyright (c) 2002-2019 Delft University of Technology, Jaffalaan 5, 2628 BX
 * Delft, the Netherlands. All rights reserved. See for project information
 * <a href="https://simulation.tudelft.nl/" target="_blank">
 * https://simulation.tudelft.nl</a>. The DSOL project is distributed under a
 * three-clause BSD-style license, which can be found at
 * <a href="https://simulation.tudelft.nl/dsol/3.0/license.html" target=
 * "_blank"> https://simulation.tudelft.nl/dsol/3.0/license.html</a>.
 * </p>
 */
public class ASWModel extends AbstractDSOLModel.TimeDouble<DEVSSimulatorInterface.TimeDouble> {
	...
	public void constructModel() throws SimRuntimeException {
		try {
			...
			// 视图组件注册：
			try {
				Visual2dService.getInstance().addVisualComponent("Fleet_1",
						new Visual2dRender(f1, simulator, new ModelData("Fleet_1")));
				Visual2dService.getInstance().addVisualComponent("Fleet_2",
						new Visual2dRender(f2, simulator, new ModelData("Fleet_2")));
				Visual2dService.getInstance().addVisualComponent("Sub_1", new Visual2dRender(s1, simulator, s1Data));
